...
function notOperaFix() {
	...
	if (isIE && document.styleSheets && document.styleSheets[0]) {
		document.styleSheets[0].addRule('img', 'behavior: url(ui/medium-white/iepngfix.htc)');
		document.styleSheets[0].addRule('div', 'behavior: url(ui/medium-white/iepngfix.htc)');
		document.styleSheets[0].addRule('.slide', 'behavior: url(ui/medium-white/iepngfix.htc)');
	}
}
